defmodule OneSignal.PlayerTest do
  ...
  describe "csv_export" do
    ...
    test "should fetch csv_export" do
      expectation = intercept(HTTPoison, :post!, ["https://onesignal.com/api/v1/players/csv_export", "{}", %{"Authorization" => "Basic alksd49peoi8apgbknm34klr53", "Content-type" => "application/json"}], with: fn(_, _, _) ->
  ...
  describe "all" do
    ...
    test "should fetch all" do
      expectation = intercept(HTTPoison, :get!, ["https://onesignal.com/api/v1/players", %{"Authorization" => "Basic alksd49peoi8apgbknm34klr53", "Content-type" => "application/json"}], with: fn(_, _) ->
        %Response{body: ~s({"foo": "bar"}), status_code: 200}
      end)
  ...
  describe "get" do
    ...
    test "should get" do
      expectation = intercept(HTTPoison, :get!, ["https://onesignal.com/api/v1/players/abc123", %{"Authorization" => "Basic alksd49peoi8apgbknm34klr53", "Content-type" => "application/json"}], with: fn(_, _) ->
        %Response{body: ~s({"foo": "bar"}), status_code: 200}
      end)
  ...
  describe "create" do
    ...
    test "should create" do
      expectation = intercept(HTTPoison, :post!, ["https://onesignal.com/api/v1/players", any(), %{"Authorization" => "Basic alksd49peoi8apgbknm34klr53", "Content-type" => "application/json"}], with: fn(_, params, _) ->
  ...
  describe "create_session" do
    ...
    test "should create session" do
      expectation = intercept(HTTPoison, :post!, ["https://onesignal.com/api/v1/players/abc123/on_session", ~s({"foo":"bar"}), %{"Authorization" => "Basic alksd49peoi8apgbknm34klr53", "Content-type" => "application/json"}], with: fn(_, _, _) ->
        %Response{body: ~s({"foo": "bar"}), status_code: 200}
      end)
  ...
  describe "create_purchase" do
    ...
    test "should create purchase" do
      expectation = intercept(HTTPoison, :post!, ["https://onesignal.com/api/v1/players/abc123/on_purchase", ~s({"foo":"bar"}), %{"Authorization" => "Basic alksd49peoi8apgbknm34klr53", "Content-type" => "application/json"}], with: fn(_, _, _) ->
        %Response{body: ~s({"foo": "bar"}), status_code: 200}
      end)
  ...
  describe "create_focus" do
    ...
    test "should create focus" do
      expectation = intercept(HTTPoison, :post!, ["https://onesignal.com/api/v1/players/abc123/on_focus", ~s({"foo":"bar"}), %{"Authorization" => "Basic alksd49peoi8apgbknm34klr53", "Content-type" => "application/json"}], with: fn(_, _, _) ->
        %Response{body: ~s({"foo": "bar"}), status_code: 200}
      end)
  ...
  describe "update" do
    ...
    test "should update player" do
      expectation = intercept(HTTPoison, :put!, ["https://onesignal.com/api/v1/players/abc123", ~s({"foo":"bar"}), %{"Authorization" => "Basic alksd49peoi8apgbknm34klr53", "Content-type" => "application/json"}], with: fn(_, _, _) ->
        %Response{body: ~s({"foo": "bar"}), status_code: 200}
      end)
